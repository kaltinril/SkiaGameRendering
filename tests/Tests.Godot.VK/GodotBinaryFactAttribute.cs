...
/// <c>samples/Sample.Godot.VK</c>, and that needs a binary this repo deliberately does not fetch.
/// <para>
...
/// would need the Godot .NET zip downloaded onto the runner plus a Vulkan device there
/// (<c>windows-latest</c> has no GPU) - a decision for the repo owner, not this test.
/// </para>
/// </summary>
